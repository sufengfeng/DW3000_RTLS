...
#define DWT_BR_110K     9   //!< UWB bit rate 110 kbits/s
...
void read_rx_power(float *rx_power);

/*! ------------------------------------------------------------------------------------------------------------------
 * @brief This function will set the value to the CIA_ADJUST_ID register.
 *
 * input parameters
 * @param pdoaOffset_deg - the offset value to be written into the CIA_ADJUST_ID register.
 *
 * return None.
 */
void dwt_setpdoaoffset(int16_t pdoaOffset_deg);
